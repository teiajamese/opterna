 ...
 * @extends  WC_Widget
 */
class WC_Widget_Product_Categories_Location extends WC_Widget {
	...
	public function __construct() {
		$this->widget_cssclass    = 'woocommerce widget_product_categories_location';
		$this->widget_description = __( 'A list or dropdown of product categories.', 'woocommerce' );
		$this->widget_id          = 'woocommerce_product_categories_location';
		$this->widget_name        = __( 'WooCommerce Product Categories & Locations', 'woocommerce' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Product Categories Locations', 'woocommerce' ),
